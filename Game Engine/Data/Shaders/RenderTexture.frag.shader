...
void main()
{
	outColor = texture(renderTexture, frag_UV);
}
...
//	vec3 ambientColor = light.ambient * texture(renderTexture, frag_UV).rgb;
//
...
//	vec3 diffuseColor = light.diffuse * cosTheta * texture(renderTexture, frag_UV).rgb;
//
