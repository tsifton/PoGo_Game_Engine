...
void main()
{
	...
	frontColor = clamp(vec4(uEmissiveColor + CalculatePhongReflection(vPosition_cameraspace, vNormalizedNormal_cameraspace), 1), 0, 1);
	backColor = clamp(vec4(uEmissiveColor + CalculatePhongReflection(vPosition_cameraspace, -vNormalizedNormal_cameraspace), 1), 0, 1);
