...
vec3 CalculatePhongReflection(vec4 vPosition_cameraspace, vec4 normalNormEye)
{
	...
	vec3 ambientColor = uAmbientLightColor * material.ambient;
	...
	vec3 diffuseColor = material.diffuse * uDiffuseLightColor * cosTheta;
	...
	vec3 specularColor = uSpecularLightColor * spec * material.specular;
